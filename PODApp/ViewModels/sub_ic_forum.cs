...
{
    [Activity(Label = "Sub Form", Theme = "@style/Theme.DesignDemo")]
    public class sub_ic_forum : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            SetContentView(Resource.Layout.sub_ic_forum);
        ...
        void setupDrawerContent(NavigationView navigationView)
        {
            ...
            {
                Toast.MakeText(this, "Sub IC NavigationItemSelected  Error Handling", ToastLength.Short).Show();
                return;
            }
        }
